...
def create_combinations(file):
    ...
    initial_path ='./training/pickles/standard and documentation/custom_elements/sec/'
    # initial_path ='./training/pickles/standard and documentation/custom_elements/small_files/'
...
if __name__ == "__main__":
    ...
    path ='./training/pickles/standard and documentation/custom_elements/sec/'
    # path ='./training/pickles/standard and documentation/custom_elements/small_files/'
